            ...
            <div class="row">
                ...
                <hr class="division" style="border-style: solid; margin: 0px 10px 40px 10px"/>
                    ...
                    <?php endif; ?>
                        ...
                        <iframe src="https://open.spotify.com/embed-podcast/episode/1LDG6B5IQWoxrqfhfAHiQs" width="100%" height="232" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>                    <hr class="division" style="border-style: solid; margin: 0px 10px 40px 10px"/>
                        <iframe src="https://open.spotify.com/embed-podcast/episode/1LDG6B5IQWoxrqfhfAHiQs" width="100%" height="160" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>                    <hr class="division" style="border-style: solid; margin: 0px 10px 40px 10px"/>
